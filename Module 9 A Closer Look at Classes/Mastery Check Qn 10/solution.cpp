/*
    For the Set class developed in Project 9-1, define < and > so they determine if one set is a subset or a superset of another set.
    Have < return true if the left set is a subset of the set on the right, and false otherwise. have > return true if the left set
    is a superset of the set on the right, and false otherwise
*/
#include <iostream>
