/*
    On your own, try putting the Queue class from Project 12-1 in its own namespace called QueueCode, and into its own file called
    Queue.cpp. Then rework the main() function so that it uses a using statement to bring QueueCode into view.
*/
#include <iostream>
#include "Queue.cpp"
using namespace std;
